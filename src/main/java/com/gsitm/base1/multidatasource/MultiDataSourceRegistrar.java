...
public class MultiDataSourceRegistrar implements ImportBeanDefinitionRegistrar, EnvironmentAware {
    ...
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        ConfigurationProperties annotation = AnnotationUtils.findAnnotation(MultiDataSourceProperties.class, ConfigurationProperties.class);
    ...
    static <T> T bindProperties(T t, String prefix, Environment environment) {
        ...
        if (t instanceof org.apache.tomcat.jdbc.pool.DataSource) {
        	((org.apache.tomcat.jdbc.pool.DataSource)t).getPoolProperties().setTestOnBorrow(true);
            ((org.apache.tomcat.jdbc.pool.DataSource)t).getPoolProperties().setValidationQuery("SELECT 1");
        }
